...
(async () => {
  ...
  if (parseInt(finalResults.numbBjcStreams) === parseInt(finalResults.resultCount)) { console.log('Matching criteria Success!!!!!!') } else { console.log('Matching criteria Failure #####') }
  console.log()
})()
